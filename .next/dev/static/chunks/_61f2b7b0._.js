...
function ChatPage() {
    ...
    if ($[0] !== "aa6051359b3990d4d0ee630c9a03383afc6f9e3106e024c89a6fb3c0c1cfc9af") {
        for(let $i = 0; $i < 102; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "aa6051359b3990d4d0ee630c9a03383afc6f9e3106e024c89a6fb3c0c1cfc9af";
    }
    let t0;
    ...
    const t24 = `p-2.5 rounded-lg transition-all duration-300 ${isDarkMode ? "bg-gray-700 hover:bg-gray-600 text-gray-300" : "bg-gray-100 hover:bg-gray-200 text-gray-700"}`;
    let t25;
    ...
    let t30;
    if ($[49] !== isDarkMode || $[50] !== isLoading) {
        t30 = isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    const t33 = `border-t px-4 py-4 backdrop-blur-sm transition-colors duration-300 ${isDarkMode ? "bg-gray-800/95 border-gray-700" : "bg-white/80 border-gray-200"}`;
    let t34;
    ...
    const t35 = `px-4 py-2 text-xs font-medium rounded-full transition-all hover:scale-105 shadow-sm ${isDarkMode ? "bg-gray-700 hover:bg-gray-600 text-gray-300 border border-gray-600" : "bg-gradient-to-r from-blue-100 to-purple-100 hover:from-blue-200 hover:to-purple-200 text-gray-700 border border-gray-300"}`;
    let t36;
    if ($[57] !== t35) {
    ...
    const t38 = `px-4 py-2 text-xs font-medium rounded-full transition-all hover:scale-105 shadow-sm ${isDarkMode ? "bg-gray-700 hover:bg-gray-600 text-gray-300 border border-gray-600" : "bg-gradient-to-r from-purple-100 to-pink-100 hover:from-purple-200 hover:to-pink-200 text-gray-700 border border-gray-300"}`;
    let t39;
    if ($[60] !== t38) {
    ...
    const t41 = `px-4 py-2 text-xs font-medium rounded-full transition-all hover:scale-105 shadow-sm ${isDarkMode ? "bg-gray-700 hover:bg-gray-600 text-gray-300 border border-gray-600" : "bg-gradient-to-r from-pink-100 to-orange-100 hover:from-pink-200 hover:to-orange-200 text-gray-700 border border-gray-300"}`;
    let t42;
    if ($[63] !== t41) {
    ...
    const t45 = `w-full px-5 py-3.5 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 pr-12 transition-all shadow-sm ${isDarkMode ? "bg-gray-700 border border-gray-600 text-white placeholder-gray-400" : "bg-white border border-gray-300 text-gray-800 placeholder-gray-500"}`;
    let t46;
    if ($[70] !== handleKeyPress || $[71] !== inputMessage || $[72] !== isLoading || $[73] !== t45) {
    ...
    const t47 = `absolute right-4 top-1/2 transform -translate-y-1/2 transition-colors ${isDarkMode ? "text-gray-400 hover:text-gray-300" : "text-gray-400 hover:text-gray-600"}`;
    let t48;
    ...
    let t51;
    if ($[81] !== inputMessage || $[82] !== isLoading) {
        t51 = !inputMessage.trim() || isLoading;
        $[81] = inputMessage;
        $[82] = isLoading;
        $[83] = t51;
    } else {
    ...
    let t53;
    if ($[85] !== handleSendMessage || $[86] !== t51) {
    ...
    let t58;
    if ($[97] !== t28 || $[98] !== t32 || $[99] !== t56 || $[100] !== t8) {
...
//# sourceMappingURL=_61f2b7b0._.js.map