...
function ChatPage() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(59);
    if ($[0] !== "aa8be32fa3d45c13b593a0faa0b5640bfbaddd3c348a8a99d837e7f75cf9e189") {
        for(let $i = 0; $i < 59; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "aa8be32fa3d45c13b593a0faa0b5640bfbaddd3c348a8a99d837e7f75cf9e189";
    }
    ...
    let t10;
    if ($[15] !== inputMessage || $[16] !== sendMessage || $[17] !== status) {
        t10 = ({
    ...
    const handleSendMessage = t10;
    let t11;
    if ($[19] !== handleSendMessage) {
        t11 = ({
    ...
    const handleClearChat = t12;
    const t13 = `flex flex-col h-[calc(100vh-4rem)] transition-colors duration-300 ${isDarkMode ? "bg-gray-900" : "bg-linear-to-br from-blue-50 via-purple-50 to-pink-50"}`;
    let t14;
    if ($[23] !== handleClearChat || $[24] !== isDarkMode) {
    ...
    let t15;
    if ($[26] !== error?.message || $[27] !== showError) {
        t15 = showError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t17;
    if ($[34] !== isDarkMode || $[35] !== status) {
        t17 = status === "submitted" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t18;
    if ($[37] !== isDarkMode || $[38] !== msg.length) {
        t18 = msg.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t21;
    if ($[46] !== handleKeyPress || $[47] !== handleSendMessage || $[48] !== inputMessage || $[49] !== isDarkMode || $[50] !== isLoading || $[51] !== status || $[52] !== stop) {
    ...
    let t22;
    if ($[54] !== t13 || $[55] !== t14 || $[56] !== t20 || $[57] !== t21) {
...
_s(ChatPage, "L9sgqwBEMz31120GrqYl0VlVTEE=", false, function() {
    return [
...
//# sourceMappingURL=src_app_b6803915._.js.map