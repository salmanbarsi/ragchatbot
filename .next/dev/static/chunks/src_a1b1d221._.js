...
function HoverCard(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(5);
    if ($[0] !== "9b1f023e4974022663cc206dce001add98bb802acf77fe0ecb5f7dbcdcc79820") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9b1f023e4974022663cc206dce001add98bb802acf77fe0ecb5f7dbcdcc79820";
    }
    let props;
    if ($[1] !== t0) {
        ({ ...props } = t0);
...
"[project]/src/components/ai-elements/prompt-input.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const usePromptInputController = ()=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(1);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7";
    }
...
function PromptInputProvider(t0) {
    _s4();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(21);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 21; $i += 1){
    ...
    const { initialInput: t1, children } = t0;
    const initialTextInput = t1 === undefined ? "" : t1;
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ({
            "PromptInputProvider[clearInput]": ()=>setTextInput("")
        })["PromptInputProvider[clearInput]"];
        $[1] = t2;
    } else {
        t2 = $[1];
    }
    ...
    const [attachements, setAttachements] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t3);
    const fileInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const openRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(_PromptInputProviderUseRef);
    let t4;
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = ({
            "PromptInputProvider[add]": (files)=>{
                const incoming = Array.from(files);
                if (incoming.length === 0) {
                    return;
                }
                setAttachements({
                    "PromptInputProvider[add > setAttachements()]": (prev)=>prev.concat(incoming.map(_PromptInputProviderAddSetAttachementsIncomingMap))
                }["PromptInputProvider[add > setAttachements()]"]);
            }
        })["PromptInputProvider[add]"];
        $[3] = t4;
    } else {
        t4 = $[3];
    }
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = ({
            "PromptInputProvider[remove]": (id)=>{
                setAttachements({
                    "PromptInputProvider[remove > setAttachements()]": (prev_0)=>{
                        const found = prev_0.find({
                            "PromptInputProvider[remove > setAttachements() > prev_0.find()]": (f)=>f.id === id
                        }["PromptInputProvider[remove > setAttachements() > prev_0.find()]"]);
                        if (found?.url) {
                            URL.revokeObjectURL(found.url);
                        }
                        return prev_0.filter({
                            "PromptInputProvider[remove > setAttachements() > prev_0.filter()]": (f_0)=>f_0.id !== id
                        }["PromptInputProvider[remove > setAttachements() > prev_0.filter()]"]);
                    }
                }["PromptInputProvider[remove > setAttachements()]"]);
            }
        })["PromptInputProvider[remove]"];
        $[4] = t5;
    } else {
        t5 = $[4];
    }
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = ({
            "PromptInputProvider[clear]": ()=>{
                setAttachements(_PromptInputProviderClearSetAttachements);
            }
        })["PromptInputProvider[clear]"];
        $[5] = t6;
    } else {
    ...
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = ({
            "PromptInputProvider[openFileDialog]": ()=>{
                openRef.current?.();
            }
        })["PromptInputProvider[openFileDialog]"];
        $[6] = t7;
    ...
    const attachments = t8;
    let t9;
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
        t9 = ({
            "PromptInputProvider[__registerFileInput]": (ref, open)=>{
                fileInputRef.current = ref.current;
                openRef.current = open;
            }
        })["PromptInputProvider[__registerFileInput]"];
        $[9] = t9;
    } else {
        t9 = $[9];
    }
    const __registerFileInput = t9;
    let t10;
    if ($[10] !== textInput) {
        t10 = {
            value: textInput,
    ...
    const controller = t11;
    let t12;
    if ($[15] !== attachments || $[16] !== children) {
        t12 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProviderAttachmentsContext.Provider, {
            value: attachments,
            children: children
        }, void 0, false, {
    ...
    let t13;
    if ($[18] !== controller || $[19] !== t12) {
        t13 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PromptInputController.Provider, {
            value: controller,
            children: t12
        }, void 0, false, {
            fileName: "[project]/src/components/ai-elements/prompt-input.tsx",
...
_s4(PromptInputProvider, "ghyiLuqxTGmBB2WEesJtK31c87E=");
_c = PromptInputProvider;
// ============================================================================
// Component Context & Hooks
// ============================================================================
function _PromptInputProviderClearSetAttachements(prev_1) {
    for (const f_1 of prev_1){
        if (f_1.url) {
            URL.revokeObjectURL(f_1.url);
        }
    }
    return [];
}
function _PromptInputProviderAddSetAttachementsIncomingMap(file) {
    return {
...
function _PromptInputProviderUseRef() {}
...
function PromptInputAttachment(t0) {
    ...
    let t2;
    if ($[7] !== data.url || $[8] !== filename || $[9] !== isImage) {
        t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    if ($[11] !== attachments || $[12] !== data.id) {
        t3 = ({
            "PromptInputAttachment[<Button>.onClick]": (e)=>{
                e.stopPropagation();
                attachments.remove(data.id);
            }
        })["PromptInputAttachment[<Button>.onClick]"];
        $[11] = attachments;
        $[12] = data.id;
        $[13] = t3;
    } else {
    ...
    let t9;
    if ($[23] !== data.id || $[24] !== props || $[25] !== t1 || $[26] !== t7 || $[27] !== t8) {
    ...
    let t10;
    if ($[29] !== data.url || $[30] !== filename || $[31] !== isImage) {
        t10 = isImage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    const t11 = filename || (isImage ? "Image" : "Attachment");
    let t12;
    if ($[33] !== t11) {
    ...
    let t13;
    if ($[35] !== data.mediaType) {
        t13 = data.mediaType && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
    ...
    let t15;
    if ($[40] !== t10 || $[41] !== t14) {
        t15 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PromptInputHoverCardContent, {
    ...
    let t16;
    if ($[43] !== t15 || $[44] !== t9) {
        t16 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PromptInputHoverCard, {
            children: [
                t9,
                t15
            ]
...
function PromptInputAttachments(t0) {
    ...
    let t1;
    if ($[5] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex flex-wrap items-center gap-2 p-3", className);
        $[5] = className;
        $[6] = t1;
    } else {
        t1 = $[6];
    ...
    let t2;
    if ($[7] !== attachments.files || $[8] !== children) {
        let t3;
        if ($[10] !== children) {
            t3 = ({
                "PromptInputAttachments[attachments.files.map()]": (file)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            ...
            })["PromptInputAttachments[attachments.files.map()]"];
            $[10] = children;
            $[11] = t3;
        } else {
            t3 = $[11];
        }
        t2 = attachments.files.map(t3);
        $[7] = attachments.files;
        $[8] = children;
        $[9] = t2;
    } else {
...
const PromptInput = (t0)=>{
    ...
    let syncHiddenInput;
    if ($[1] !== t0) {
        ({ className, accept, multiple, globalDrop, syncHiddenInput, maxFiles, maxFileSize, onError, onSubmit, children, ...props } = t0);
        $[1] = t0;
        $[2] = accept;
        $[3] = children;
        $[4] = className;
    ...
    const [items, setItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t3);
    ...
    let t6;
    if ($[19] !== matchesAccept || $[20] !== maxFileSize || $[21] !== maxFiles || $[22] !== onError) {
        t6 = (fileList)=>{
    ...
    const addLocal = t6;
    let t7;
    if ($[24] !== addLocal || $[25] !== controller || $[26] !== usingProvider) {
        t7 = usingProvider ? (files_0)=>controller.attachments.add(files_0) : addLocal;
        $[24] = addLocal;
        $[25] = controller;
        $[26] = usingProvider;
        $[27] = t7;
    ...
    const add = t7;
    let t8;
    if ($[28] !== controller || $[29] !== usingProvider) {
        t8 = usingProvider ? (id)=>controller.attachments.remove(id) : (id_0)=>setItems((prev_0)=>{
                const found = prev_0.find((file_0)=>file_0.id === id_0);
                if (found?.url) {
                    URL.revokeObjectURL(found.url);
                }
                return prev_0.filter((file_1)=>file_1.id !== id_0);
            });
        $[28] = controller;
        $[29] = usingProvider;
        $[30] = t8;
    ...
    const remove = t8;
    let t9;
    if ($[31] !== controller || $[32] !== usingProvider) {
        t9 = usingProvider ? ()=>controller.attachments.clear() : ()=>setItems(_temp);
        $[31] = controller;
        $[32] = usingProvider;
        $[33] = t9;
    } else {
    ...
    const clear = t9;
    let t10;
    if ($[34] !== controller || $[35] !== usingProvider) {
        t10 = usingProvider ? ()=>controller.attachments.openFileDialog() : openFileDialogLocal;
        $[34] = controller;
        $[35] = usingProvider;
        $[36] = t10;
    } else {
    ...
    const openFileDialog = t10;
    let t11;
    let t12;
    if ($[37] !== controller || $[38] !== usingProvider) {
        t11 = ()=>{
            if (!usingProvider) {
                return;
            }
    ...
    let t13;
    if ($[41] !== files.length || $[42] !== syncHiddenInput) {
        t13 = ()=>{
    ...
    let t14;
    if ($[44] !== files || $[45] !== syncHiddenInput) {
        t14 = [
            files,
            syncHiddenInput
        ];
    ...
    if ($[47] !== add) {
        t15 = ()=>{
            ...
            const onDrop = (e_0)=>{
                if (e_0.dataTransfer?.types?.includes("Files")) {
                    e_0.preventDefault();
                }
                if (e_0.dataTransfer?.files && e_0.dataTransfer.files.length > 0) {
    ...
    if ($[50] !== add || $[51] !== globalDrop) {
        t17 = ()=>{
            ...
            const onDrop_0 = (e_2)=>{
                if (e_2.dataTransfer?.types?.includes("Files")) {
                    e_2.preventDefault();
                }
    ...
    let t19;
    let t20;
    if ($[54] !== files || $[55] !== usingProvider) {
        t19 = ()=>()=>{
                if (!usingProvider) {
                    for (const f_2 of files){
                        if (f_2.url) {
                            URL.revokeObjectURL(f_2.url);
                        }
                    }
                }
            };
    ...
    const handleChange = t21;
    const convertBlobUrlToDataUrl = _temp4;
    let t22;
    if ($[60] !== files) {
        t22 = files.map(_temp5);
        $[60] = files;
        $[61] = t22;
    } else {
        t22 = $[61];
    ...
    let t23;
    if ($[62] !== add || $[63] !== clear || $[64] !== openFileDialog || $[65] !== remove || $[66] !== t22) {
        t23 = {
            files: t22,
            add,
            remove,
    ...
    const ctx = t23;
    let t24;
    if ($[68] !== clear || $[69] !== controller || $[70] !== files || $[71] !== onSubmit || $[72] !== usingProvider) {
        t24 = (event_0)=>{
            event_0.preventDefault();
            const form_0 = event_0.currentTarget;
            const text = usingProvider ? controller.textInput.value : (()=>{
                const formData = new FormData(form_0);
                return formData.get("message") || "";
            })();
            if (!usingProvider) {
                form_0.reset();
            }
            Promise.all(files.map(async (t25)=>{
                const { id: id_1, ...item_0 } = t25;
                if (item_0.url && item_0.url.startsWith("blob:")) {
                    return {
                        ...item_0,
                        url: await convertBlobUrlToDataUrl(item_0.url)
                    };
                }
                return item_0;
            })).then((convertedFiles)=>{
    ...
    let t26;
    if ($[75] !== accept || $[76] !== handleChange || $[77] !== multiple) {
    ...
    let t27;
    if ($[79] !== className) {
        t27 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-full", className);
        $[79] = className;
        $[80] = t27;
    } else {
        t27 = $[80];
    ...
    let t29;
    if ($[83] !== handleSubmit || $[84] !== props || $[85] !== t27 || $[86] !== t28) {
    ...
    const inner = t30;
    let t31;
    if ($[91] !== ctx || $[92] !== inner || $[93] !== usingProvider) {
        t31 = usingProvider ? inner : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LocalAttachmentsContext.Provider, {
            value: ctx,
            children: inner
        }, void 0, false, {
            fileName: "[project]/src/components/ai-elements/prompt-input.tsx",
...
_s9(PromptInput, "NuFx8ZRyCr0CLdXSPfw4ajz6BSs=", false, function() {
    return [
...
const PromptInputBody = (t0)=>{
    ...
    let t1;
    if ($[4] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("contents", className);
        $[4] = className;
        $[5] = t1;
    } else {
        t1 = $[5];
...
const PromptInputTextarea = (t0)=>{
    ...
    let t2;
    if ($[6] !== attachments || $[7] !== isComposing) {
        t2 = (e)=>{
            if (e.key === "Enter") {
    ...
    let t4;
    if ($[11] !== controller || $[12] !== onChange) {
        t4 = controller ? {
            value: controller.textInput.value,
            onChange: (e_0)=>{
                controller.textInput.setInput(e_0.currentTarget.value);
                onChange?.(e_0);
            }
        } : {
            onChange
    ...
    const controlledProps = t4;
    let t5;
    if ($[14] !== className) {
        t5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("field-sizing-content max-h-48 min-h-16", className);
        $[14] = className;
        $[15] = t5;
    } else {
        t5 = $[15];
    ...
    let t7;
    if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = ()=>setIsComposing(false);
        t7 = ()=>setIsComposing(true);
        $[16] = t6;
        $[17] = t7;
    } else {
        t6 = $[16];
    ...
    let t8;
    if ($[18] !== controlledProps || $[19] !== handleKeyDown || $[20] !== handlePaste || $[21] !== placeholder || $[22] !== props || $[23] !== t5) {
        t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2d$group$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InputGroupTextarea"], {
            className: t5,
            name: "message",
            onCompositionEnd: t6,
            onCompositionStart: t7,
...
const PromptInputHeader = (t0)=>{
    ...
    let t1;
    if ($[4] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("order-first flex-wrap gap-1", className);
        $[4] = className;
        $[5] = t1;
    } else {
        t1 = $[5];
...
const PromptInputFooter = (t0)=>{
    ...
    let t1;
    if ($[4] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("justify-between gap-1", className);
        $[4] = className;
        $[5] = t1;
    } else {
        t1 = $[5];
...
const PromptInputButton = (t0)=>{
    ...
    if ($[1] !== t0) {
        ...
        t1 = size ?? (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Children"].count(props.children) > 1 ? "sm" : "icon-sm");
        $[1] = t0;
        $[2] = className;
        $[3] = props;
        $[4] = t1;
    ...
    let t2;
    if ($[6] !== className) {
        t2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(className);
        $[6] = className;
        $[7] = t2;
    } else {
        t2 = $[7];
    ...
    let t3;
    if ($[8] !== newSize || $[9] !== props || $[10] !== t2 || $[11] !== variant) {
...
const PromptInputSubmit = (t0)=>{
    ...
    let t2;
    if ($[1] !== t0) {
        ({ className, variant: t1, size: t2, status, children, ...props } = t0);
        $[1] = t0;
        $[2] = children;
        $[3] = className;
        $[4] = props;
    ...
    let t4;
    if ($[12] !== className) {
        t4 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(className);
        $[12] = className;
        $[13] = t4;
    } else {
        t4 = $[13];
    }
    const t5 = children ?? Icon;
    let t6;
    if ($[14] !== props || $[15] !== size || $[16] !== t4 || $[17] !== t5 || $[18] !== variant) {
        t6 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2d$group$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InputGroupButton"], {
            "aria-label": "Submit",
            className: t4,
            size: size,
...
const PromptInputSpeechButton = (t0)=>{
    _s11();
    ...
    let className;
    let onTranscriptionChange;
    let props;
    let textareaRef;
    if ($[1] !== t0) {
        ({ className, textareaRef, onTranscriptionChange, ...props } = t0);
        $[1] = t0;
        $[2] = className;
        $[3] = onTranscriptionChange;
        $[4] = props;
        $[5] = textareaRef;
    } else {
        className = $[2];
        onTranscriptionChange = $[3];
        props = $[4];
        textareaRef = $[5];
    }
    ...
    let t1;
    let t2;
    if ($[6] !== onTranscriptionChange || $[7] !== textareaRef) {
        t1 = ()=>{
            if (("TURBOPACK compile-time value", "object") !== "undefined" && ("SpeechRecognition" in window || "webkitSpeechRecognition" in window)) {
                ...
                speechRecognition.onerror = (event_0)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(t1, t2);
    let t3;
    if ($[10] !== isListening || $[11] !== recognition) {
        t3 = ()=>{
            if (!recognition) {
                return;
            }
    ...
    const toggleListening = t3;
    const t4 = isListening && "animate-pulse bg-accent text-accent-foreground";
    let t5;
    if ($[13] !== className || $[14] !== t4) {
        t5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("relative transition-all duration-200", t4, className);
        $[13] = className;
        $[14] = t4;
        $[15] = t5;
    } else {
    ...
    let t8;
    if ($[17] !== props || $[18] !== t5 || $[19] !== t6 || $[20] !== toggleListening) {
        t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PromptInputButton, {
            className: t5,
            disabled: t6,
...
_s11(PromptInputSpeechButton, "0VtgugHg3+QP+JHFp+5cZRlQl/w=");
_c16 = PromptInputSpeechButton;
const PromptInputSelect = (props)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(3);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputSelectTrigger = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputSelectContent = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputSelectItem = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputSelectValue = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputHoverCard = (t0)=>{
    ...
    let t2;
    if ($[1] !== t0) {
        ({ openDelay: t1, closeDelay: t2, ...props } = t0);
        $[1] = t0;
        $[2] = props;
        $[3] = t1;
        $[4] = t2;
    ...
    const openDelay = t1 === undefined ? 0 : t1;
    const closeDelay = t2 === undefined ? 0 : t2;
    let t3;
    if ($[5] !== closeDelay || $[6] !== openDelay || $[7] !== props) {
...
const PromptInputHoverCardTrigger = (props)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(3);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputHoverCardContent = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(7);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputTabLabel = (t0)=>{
    ...
    let t1;
    if ($[4] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("mb-2 px-3 font-medium text-muted-foreground text-xs", className);
        $[4] = className;
        $[5] = t1;
    } else {
        t1 = $[5];
...
const PromptInputTabBody = (t0)=>{
    ...
    let t1;
    if ($[4] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("space-y-1", className);
        $[4] = className;
        $[5] = t1;
    } else {
        t1 = $[5];
...
const PromptInputTabItem = (t0)=>{
    ...
    let t1;
    if ($[4] !== className) {
        t1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex items-center gap-2 px-3 py-2 text-xs hover:bg-accent", className);
        $[4] = className;
        $[5] = t1;
    } else {
        t1 = $[5];
...
const PromptInputCommandInput = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputCommandList = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputCommandEmpty = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputCommandGroup = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputCommandItem = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
const PromptInputCommandSeparator = (t0)=>{
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "1c9d0d9ae678b4194401103cd556dfd3eac547f0dae13ff36900ceaed4e4e1d7") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
...
function _temp3(e_1) {
    if (e_1.dataTransfer?.types?.includes("Files")) {
        e_1.preventDefault();
    }
}
async function _temp4(url) {
...
"[project]/src/app/component/Conversationpage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ai-elements/prompt-input.tsx [app-client] (ecmascript)");
...
const Conversationpage = ()=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(25);
    if ($[0] !== "f3c2bdb445595aa4c3cf6e5cfcbae40501877cca2594b8bf2508a6197c307a14") {
        for(let $i = 0; $i < 25; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f3c2bdb445595aa4c3cf6e5cfcbae40501877cca2594b8bf2508a6197c307a14";
    }
    ...
    if ($[3] !== messages) {
        t1 = messages.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ai$2d$elements$2f$conversation$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ConversationEmptyState"], {
            ...
            lineNumber: 44,
            columnNumber: 34
        }, ("TURBOPACK compile-time value", void 0)) : messages.map(_temp);
        $[3] = messages;
        $[4] = t1;
    } else {
        t1 = $[4];
    ...
    let t5;
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = (e_0)=>setInput(e_0.currentTarget.value);
        $[10] = t5;
    } else {
        t5 = $[10];
    }
    let t6;
    if ($[11] !== input) {
        t6 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputTextarea"], {
            value: input,
    ...
    const t7 = status === "streaming" ? "streaming" : "ready";
    let t8;
    if ($[13] !== input) {
        t8 = input.trim();
        $[13] = input;
    ...
    let t10;
    if ($[15] !== t7 || $[16] !== t9) {
        t10 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInputSubmit"], {
            status: t7,
            disabled: t9,
    ...
    let t11;
    if ($[18] !== handleSubmit || $[19] !== t10 || $[20] !== t6) {
        t11 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ai$2d$elements$2f$prompt$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PromptInput"], {
            onSubmit: handleSubmit,
...
_s(Conversationpage, "xxNDmJQjb0aYr5wLS86zeT43iwM=", false, function() {
    return [
...
function _temp(message_0) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ai$2d$elements$2f$message$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Message"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ai$2d$elements$2f$message$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MessageContent"], {
            children: message_0.parts.map((part, i)=>{
                switch(part.type){
                    case "text":
                        {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/compiler-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$component$2f$Conversationpage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/component/Conversationpage.tsx [app-client] (ecmascript)");
"use client";
;
;
;
function RAGchatbot() {
    ...
    if ($[0] !== "08ac5ec9763ceae966378bc5caa85e5130e73cf6a552595f976e1e56f53194f5") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "08ac5ec9763ceae966378bc5caa85e5130e73cf6a552595f976e1e56f53194f5";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$component$2f$Conversationpage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
_c = RAGchatbot;
var _c;
__turbopack_context__.k.register(_c, "RAGchatbot");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_a1b1d221._.js.map