...
function ChatPage() {
    ...
    const handleSendMessage = async ()=>{
        ...
        if (selectedFiles.length > 0) {
            const file = selectedFiles[0]; // you can extend for multiple later
            ...
            // --- Upload to server (processpdfFile) ---
            const formData = new FormData();
            formData.append("pdf", file);
            const result = await processpdfFile(formData);
            // Add response into chat
            setMessages((prev)=>[
                    ...prev,
                    {
                        id: Date.now() + 1,
                        text: result.success ? "PDF processed successfully!" : "Error processing PDF: " + result.error,
                        files: [],
                        isUser: false,
                        timestamp: new Date()
                    }
                            ...
                            children: [
                                ...
                                message.files && message.files.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: message.files.map((file, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "p-2 rounded-lg border bg-gray-100 flex items-center space-x-2",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(ChatPage, "wvWjb9FvapF9aZSgQi7FBjYTNyM=", false, function() {
    return [
...
//# sourceMappingURL=src_app_fa5ed5d3._.js.map