...
const Header = (t0)=>{
    ...
    if ($[0] !== "c2b41e0eed280a23d654fd2535cd542d881e321ba3b35b4c81d21b16753fa0be") {
        for(let $i = 0; $i < 30; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c2b41e0eed280a23d654fd2535cd542d881e321ba3b35b4c81d21b16753fa0be";
    }
...
const Inputarea = (t0)=>{
    ...
    if ($[0] !== "ca405b889a85ba1f7ff36f250491671a9e0b64cb6eb24e8b5eb6f4c3002d085d") {
        for(let $i = 0; $i < 51; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ca405b889a85ba1f7ff36f250491671a9e0b64cb6eb24e8b5eb6f4c3002d085d";
    }
    const { isDarkMode, setInputMessage, inputMessage, isLoading, handleKeyPress, handleSendMessage } = t0;
    let t1;
    if ($[1] !== setInputMessage) {
        t1 = (action)=>{
            const quickMessages = {
    ...
    const handleQuickAction = t1;
    const t2 = `border-t px-4 py-4 backdrop-blur-sm transition-colors duration-300 ${isDarkMode ? "bg-gray-800/95 border-gray-700" : "bg-white/80 border-gray-200"}`;
    let t3;
    if ($[3] !== handleQuickAction) {
        t3 = ()=>handleQuickAction("ideas");
        $[3] = handleQuickAction;
        $[4] = t3;
    } else {
        t3 = $[4];
    }
    const t4 = `px-4 py-2 text-xs font-medium rounded-full transition-all hover:scale-105 shadow-sm ${isDarkMode ? "bg-gray-700 hover:bg-gray-600 text-gray-300 border border-gray-600" : "bg-gradient-to-r from-blue-100 to-purple-100 hover:from-blue-200 hover:to-purple-200 text-gray-700 border border-gray-300"}`;
    let t5;
    if ($[5] !== t3 || $[6] !== t4) {
    ...
    let t6;
    if ($[8] !== handleQuickAction) {
        t6 = ()=>handleQuickAction("summarize");
        $[8] = handleQuickAction;
        $[9] = t6;
    } else {
        t6 = $[9];
    }
    const t7 = `px-4 py-2 text-xs font-medium rounded-full transition-all hover:scale-105 shadow-sm ${isDarkMode ? "bg-gray-700 hover:bg-gray-600 text-gray-300 border border-gray-600" : "bg-gradient-to-r from-purple-100 to-pink-100 hover:from-purple-200 hover:to-pink-200 text-gray-700 border border-gray-300"}`;
    let t8;
    if ($[10] !== t6 || $[11] !== t7) {
    ...
    let t9;
    if ($[13] !== handleQuickAction) {
        t9 = ()=>handleQuickAction("explain");
        $[13] = handleQuickAction;
        $[14] = t9;
    } else {
        t9 = $[14];
    }
    const t10 = `px-4 py-2 text-xs font-medium rounded-full transition-all hover:scale-105 shadow-sm ${isDarkMode ? "bg-gray-700 hover:bg-gray-600 text-gray-300 border border-gray-600" : "bg-gradient-to-r from-pink-100 to-orange-100 hover:from-pink-200 hover:to-orange-200 text-gray-700 border border-gray-300"}`;
    let t11;
    if ($[15] !== t10 || $[16] !== t9) {
    ...
    let t13;
    if ($[22] !== setInputMessage) {
        t13 = (e)=>setInputMessage(e.target.value);
        $[22] = setInputMessage;
        $[23] = t13;
    } else {
        t13 = $[23];
    }
    const t14 = `w-full px-5 py-3.5 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 pr-12 transition-all shadow-sm ${isDarkMode ? "bg-gray-700 border border-gray-600 text-white placeholder-gray-400" : "bg-white border border-gray-300 text-gray-800 placeholder-gray-500"}`;
    let t15;
    if ($[24] !== handleKeyPress || $[25] !== inputMessage || $[26] !== isLoading || $[27] !== t13 || $[28] !== t14) {
    ...
    const t16 = `absolute right-4 top-1/2 transform -translate-y-1/2 transition-colors ${isDarkMode ? "text-gray-400 hover:text-gray-300" : "text-gray-400 hover:text-gray-600"}`;
    let t17;
    ...
    let t20;
    if ($[36] !== inputMessage || $[37] !== isLoading) {
        t20 = !inputMessage.trim() || isLoading;
        $[36] = inputMessage;
        $[37] = isLoading;
        $[38] = t20;
    } else {
    ...
    let t22;
    if ($[40] !== handleSendMessage || $[41] !== t20) {
...
function ChatPage() {
    ...
    if ($[0] !== "b7f7f57ec3fd861160eee6ff4695d3a9604cf97303dde194aa3c440fe4e7e4aa") {
        for(let $i = 0; $i < 37; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b7f7f57ec3fd861160eee6ff4695d3a9604cf97303dde194aa3c440fe4e7e4aa";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [];
    ...
    const handleClearChat = t6;
    const t7 = `flex flex-col h-screen transition-colors duration-300 ${isDarkMode ? "bg-gray-900" : "bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50"}`;
    let t8;
    if ($[12] !== isDarkMode) {
    ...
    let t10;
    if ($[19] !== isDarkMode || $[20] !== isLoading) {
        t10 = isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t13;
    if ($[26] !== handleKeyPress || $[27] !== handleSendMessage || $[28] !== inputMessage || $[29] !== isDarkMode || $[30] !== isLoading) {
...
_s(ChatPage, "fygE/SuToOL5SqHdZUb2yzJcl70=");
_c = ChatPage;
...
//# sourceMappingURL=_b72ab7cc._.js.map