...
const Header = (t0)=>{
    ...
    if ($[0] !== "5fc9427144efc3f43d7b2e69f80fa333e5a824f4bdd8bdb52f6f03cb073af494") {
        for(let $i = 0; $i < 30; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5fc9427144efc3f43d7b2e69f80fa333e5a824f4bdd8bdb52f6f03cb073af494";
    }
    ...
    let t11;
    if ($[13] !== isDarkMode) {
        t11 = isDarkMode ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Su, {
            className: "w-5 h-5"
        }, void 0, false, {
            fileName: "[project]/src/app/component/Header.tsx",
            lineNumber: 71,
...
function ChatPage() {
    ...
    if ($[0] !== "c3a5a095546d6b32d73e54691bf2412e71756a611065c70e92c9e5d133da5d2d") {
        for(let $i = 0; $i < 73; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c3a5a095546d6b32d73e54691bf2412e71756a611065c70e92c9e5d133da5d2d";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [
    ...
    const t14 = `border-t px-4 py-4 backdrop-blur-sm transition-colors duration-300 ${isDarkMode ? "bg-gray-800/95 border-gray-700" : "bg-white/80 border-gray-200"}`;
    let t15;
    ...
    const t16 = `px-4 py-2 text-xs font-medium rounded-full transition-all hover:scale-105 shadow-sm ${isDarkMode ? "bg-gray-700 hover:bg-gray-600 text-gray-300 border border-gray-600" : "bg-gradient-to-r from-blue-100 to-purple-100 hover:from-blue-200 hover:to-purple-200 text-gray-700 border border-gray-300"}`;
    let t17;
    if ($[28] !== t16) {
    ...
    const t19 = `px-4 py-2 text-xs font-medium rounded-full transition-all hover:scale-105 shadow-sm ${isDarkMode ? "bg-gray-700 hover:bg-gray-600 text-gray-300 border border-gray-600" : "bg-gradient-to-r from-purple-100 to-pink-100 hover:from-purple-200 hover:to-pink-200 text-gray-700 border border-gray-300"}`;
    let t20;
    if ($[31] !== t19) {
    ...
    const t22 = `px-4 py-2 text-xs font-medium rounded-full transition-all hover:scale-105 shadow-sm ${isDarkMode ? "bg-gray-700 hover:bg-gray-600 text-gray-300 border border-gray-600" : "bg-gradient-to-r from-pink-100 to-orange-100 hover:from-pink-200 hover:to-orange-200 text-gray-700 border border-gray-300"}`;
    let t23;
    if ($[34] !== t22) {
    ...
    const t26 = `w-full px-5 py-3.5 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 pr-12 transition-all shadow-sm ${isDarkMode ? "bg-gray-700 border border-gray-600 text-white placeholder-gray-400" : "bg-white border border-gray-300 text-gray-800 placeholder-gray-500"}`;
    let t27;
    if ($[41] !== handleKeyPress || $[42] !== inputMessage || $[43] !== isLoading || $[44] !== t26) {
    ...
    const t28 = `absolute right-4 top-1/2 transform -translate-y-1/2 transition-colors ${isDarkMode ? "text-gray-400 hover:text-gray-300" : "text-gray-400 hover:text-gray-600"}`;
    let t29;
    ...
    let t32;
    if ($[52] !== inputMessage || $[53] !== isLoading) {
        t32 = !inputMessage.trim() || isLoading;
        $[52] = inputMessage;
        $[53] = isLoading;
        $[54] = t32;
    } else {
    ...
    let t34;
    if ($[56] !== handleSendMessage || $[57] !== t32) {
...
//# sourceMappingURL=_9a2c9689._.js.map