...
async function extractPdfText(buffer) {
    return new Promise((resolve, reject)=>{
        try {
            const pdfParser = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf2json$2f$dist$2f$pdfparser$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]();
            ...
            pdfParser.on("pdfParser_dataReady", (pdfData)=>{
                ...
                pages.forEach((page)=>{
                    page.Texts.forEach((t)=>{
                        const decoded = decodeURIComponent(t.R.map((r)=>r.T).join(" "));
                        extracted += decoded + " ";
                    });
                    extracted += "\n\n";
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07a3d4a9._.js.map